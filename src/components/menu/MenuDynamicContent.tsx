...
/**
 * MenuDynamicContent - Data-dependent content that loads asynchronously.
 * This component handles categories, products, search, and promotions.
 * It is mounted inside MenuLayoutBase and can change without affecting the static shell.
 */
export const MenuDynamicContent = () => {
  ...
  // Filter items by search query - operates ONLY on loaded data
  ...
  return (
    <>
      {/* Category Chips - Always render the container */}
      <CategoryChips
      ...
      {/* Search Field - Always visible, operates on loaded data only */}
